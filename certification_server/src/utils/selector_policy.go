...
func PickRoundRobin(instances []*commonmodel.ServiceInstance, counter int) *commonmodel.ServiceInstance {
	if len(instances) == 0 {
		return nil
	}
...
func PickLeastWeightedLatency(
	instances []*commonmodel.ServiceInstance,
	latency map[string]float64,
) *commonmodel.ServiceInstance {
	if len(instances) == 0 {
		return nil
	}
	var best *commonmodel.ServiceInstance
...
func PickHashAffinity(instances []*commonmodel.ServiceInstance, affinityKey string) *commonmodel.ServiceInstance {
	if len(instances) == 0 {
		return nil
	}
...
func FilterByTags(instances []*commonmodel.ServiceInstance, requireTags []string) []*commonmodel.ServiceInstance {
	...
	var result []*commonmodel.ServiceInstance
	for _, inst := range instances {
...
func RandomWeighted(instances []*commonmodel.ServiceInstance) *commonmodel.ServiceInstance {
	if len(instances) == 0 {
		return nil
	}
	totalWeight := 0
