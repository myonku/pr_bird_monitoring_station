...
var (
	...
	ErrUserNotFound                           Error = *NewError(AuthErr, "user not found")
	ErrUserDisabled                           Error = *NewError(AuthErr, "user is disabled")
	ErrUserBanned                             Error = *NewError(AuthErr, "user is banned")
	ErrUserRiskRejected                       Error = *NewError(AuthErr, "user is rejected by risk control")
