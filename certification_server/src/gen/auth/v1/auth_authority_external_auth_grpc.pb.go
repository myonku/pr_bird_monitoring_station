...
const (
	...
	AuthAuthorityExternalAuthService_ForwardRefreshTokenBundle_FullMethodName    = "/bms.auth.v1.AuthAuthorityExternalAuthService/ForwardRefreshTokenBundle"
...
type AuthAuthorityExternalAuthServiceClient interface {
	...
	ForwardRefreshTokenBundle(ctx context.Context, in *TokenRefreshRequest, opts ...grpc.CallOption) (*TokenBundle, error)
...
func (c *authAuthorityExternalAuthServiceClient) ForwardRefreshTokenBundle(ctx context.Context, in *TokenRefreshRequest, opts ...grpc.CallOption) (*TokenBundle, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TokenBundle)
	err := c.cc.Invoke(ctx, AuthAuthorityExternalAuthService_ForwardRefreshTokenBundle_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthAuthorityExternalAuthServiceServer interface {
	...
	// auth.external.forward.token_refresh_bundle -> ForwardRefreshTokenBundle.
	ForwardRefreshTokenBundle(context.Context, *TokenRefreshRequest) (*TokenBundle, error)
	// auth.external.forward.bootstrap.challenge -> ForwardBootstrapChallenge.
...
func (UnimplementedAuthAuthorityExternalAuthServiceServer) ForwardRefreshTokenBundle(context.Context, *TokenRefreshRequest) (*TokenBundle, error) {
	return nil, status.Error(codes.Unimplemented, "method ForwardRefreshTokenBundle not implemented")
}
...
func _AuthAuthorityExternalAuthService_ForwardRefreshTokenBundle_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TokenRefreshRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthAuthorityExternalAuthServiceServer).ForwardRefreshTokenBundle(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthAuthorityExternalAuthService_ForwardRefreshTokenBundle_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthAuthorityExternalAuthServiceServer).ForwardRefreshTokenBundle(ctx, req.(*TokenRefreshRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthAuthorityExternalAuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ForwardRefreshTokenBundle",
			Handler:    _AuthAuthorityExternalAuthService_ForwardRefreshTokenBundle_Handler,
		},
		{
