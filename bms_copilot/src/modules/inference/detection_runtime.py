...
from src.models.inference.workflow import DetectionBox
from src.modules.inference.runtime_common import normalize_input_size, safe_label

class DetectionRuntime:
    """提供检测推理功能的运行时组件，支持 YOLO / PyTorch / ONNX。"""
