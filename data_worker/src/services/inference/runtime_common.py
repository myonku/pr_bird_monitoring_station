...
from src.models.inference.workflow import InferenceImagePayload, InferenceModelArtifact
...
def load_rgb(image: InferenceImagePayload) -> Image.Image:
...
def build_model_signature(
    handle: dict[str, Any],
    artifact: InferenceModelArtifact,
) -> str:
    candidate_id = str(
