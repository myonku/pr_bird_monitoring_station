...
var (
	...
	ErrInternalAssertionSignerRequired        Error = *NewError(AuthErr, "internal assertion signer is required")
	ErrInternalAssertionBuildRequestNil       Error = *NewError(AuthErr, "internal assertion build request is nil")
	ErrInternalAssertionMarshalFailed         Error = *NewError(AuthErr, "marshal internal assertion payload failed")
	ErrInternalAssertionSignFailed            Error = *NewError(AuthErr, "sign internal assertion failed")
	ErrInternalAssertionSignatureEncodeFailed Error = *NewError(AuthErr, "encode internal assertion signature failed")
	...
	ErrSessionIDOrRefreshRequired             Error = *NewError(AuthErr, "session id or refresh token is required")
	ErrHTTPServerNotConfigured                Error = *NewError(AppErr, "http server is not configured")
)
